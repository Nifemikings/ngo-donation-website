...
<head>
  ...
  ?>
  <title>Home | Charity / Non-profit responsive Bootstrap HTML5 template</title>
  <!-- Owl carousel -->
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
                ...
                <form class="form-donation" id ="payment-form" method="POST" action="checkout.php">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12 ">
                                <input type="text" class="form-control" id="amount" name="amount" required placeholder="AMOUNT($)">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                <input type="text" class="form-control" id="donor-email" name="email" required placeholder="EMAIL">
                            </div>
